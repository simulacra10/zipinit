---
title: "Representation Is Broken. Here Is Why."
browserTitle: "Representation Is Broken"
description: "A short film and essay on why U.S. representation stopped scaling to real communities, and what to do about it."
url: /representation-is-broken.html
jsonldType: "article-video"
jsonldAbout: true
videoName: "Representation Is Broken. Here Is Why."
...
{{< video src="/mp3-mp4/representation-is-broken/REPRESENTATION%20IS%20BROKEN.mp4" vtt="/mp3-mp4/representation-is-broken/representation-is-broken.vtt" >}}

Representation is broken.<br>
Here is why.

The United States was designed to represent people and places.

Over time, we kept the population.<br>
We erased the places.

This matters more than most political arguments we have today.

Because many of our frustrations are not ideological problems.<br>
They are structural ones.

## What Changed

### <span class="num">1.</span> The House of Representatives Stopped Growing
...
The Constitution never required this.<br>
...
### <span class="num">2.</span> The Senate Stopped Representing States
...
### <span class="num">3.</span> Districts Replaced Communities
...
This is not radical.<br>
It is corrective.

### <span class="num">1.</span> ZIP Code Representation (State Level)
...
### <span class="num">2.</span> County Representation (Federal Level)
...
This does not make representation equal by population.<br>
It makes representation legible by place.

### <span class="num">3.</span> Restore the Original Senate
...
Smaller units do not guarantee good governance.<br>
But oversized units almost guarantee distance.

This is not a party issue.<br>
This is a scale issue.

## Questions Worth Asking

- Why was the House capped when the Constitution never required it?
...
- At what point does representation become symbolic rather than personal?

These are not radical questions.<br>
...
**Contact:**<br>
Signal @zipinit.12 &middot; [secure (PGP) email](/contact.html)

<p class="stamp">Copy freely.<br>
Share it.<br>
Change it.</p>

<p class="stamp">Creative Commons CC0.<br>
No permission required.</p>
