...
#+AUTHOR: Norman Bauer
#+ORGANIZATION: ZIP Apportionment Initiative
#+URL: https://zipinit.org
#+EMAIL: expand@zipinit.org
#+LANGUAGE: en
#+OPTIONS: toc:2 num:t
#+STARTUP: showall
#+LATEX_HEADER: \usepackage{xcolor}
#+LATEX_HEADER: \definecolor{ziplink}{HTML}{2B4A6B}
#+LATEX_HEADER: \hypersetup{colorlinks=true, linkcolor=black, citecolor=black, urlcolor=ziplink, pdfborder={0 0 0}}
#+EXPORT_FILE_NAME: zip-apportionment-vs-redistricting-commissions-vs-ranked-choice-voting

* ZIP Apportionment vs. Independent Redistricting Commissions vs. Ranked-Choice Voting

- *Norman Bauer*
- ZIP Apportionment Initiative
- [[https://zipinit.org][https://zipinit.org]]
- [[mailto:expand@zipinit.org][expand@zipinit.org]]
...
** Independent Redistricting Commissions: Moving the Mapmakers
...
*** Virginia’s bipartisan commission

Virginia’s redistricting commission provides a particularly clear example.

The commission consisted of 16 members: eight legislators and eight citizens. The legislative seats were divided between members of the two largest parties in the Virginia Senate and House of Delegates and filled by the respective legislative leaders.[fn:1]

The citizen commissioners were not selected in a statewide election. Legislative leaders submitted lists of proposed citizen members to a selection committee composed of retired judges, which then chose the eight citizen commissioners.[fn:2]

During a June 2021 meeting, citizen commissioner Richard Harrell directly addressed the distinction between independence and nonpartisanship. The official meeting summary records that Harrell described the commission as “not nonpartisan but rather bipartisan” and observed that its members had been selected on a partisan basis.[fn:3]
...
*** What commissions leave unchanged
...
*** What ranked-choice voting may improve
...
*** What ranked-choice voting leaves unchanged
...
** ZIP Apportionment: Changing the Geographic Foundation
...
** ZIP Codes Require a Precise Legal Definition

ZIP Codes were created for mail delivery, not political representation.

They also are not geographic polygons in the same sense as counties, municipalities or legislative districts. The Census Bureau explains that postal ZIP Codes are collections of delivery routes and points rather than conventional areas.[fn:7]

To publish demographic and geographic data associated with ZIP Codes, the Census Bureau creates ZIP Code Tabulation Areas, or ZCTAs. ZCTAs are generalized area representations constructed from census blocks to approximate the geographic distribution of ZIP Code service areas.[fn:8]

A ZCTA is not identical to a postal ZIP Code.

Not every postal ZIP Code corresponds to a conventional residential area. Some ZIP Codes principally serve post-office boxes, organizations or particular delivery functions. Census geography also shows that ZCTAs need not remain entirely within county, municipal or even state boundaries.[fn:9]
...
** What ZIP Apportionment Would Improve
...
** What ZIP Apportionment Would Not Automatically Solve
...
The Supreme Court’s one-person, one-vote cases require state and local legislative districts to be constructed on a substantially equal-population basis. The Court has stated that when members of an elected body are chosen from separate districts, those districts must, as far as practicable, allow equal numbers of people to elect proportionally equal numbers of representatives.[fn:10]
...
** Which One Confronts Gerrymandering?
...
But partisan gerrymandering is accomplished through the strategic placement of district lines. The Supreme Court has described it as drawing legislative districts to subordinate one political party’s supporters and entrench a rival party in power.[fn:12]
...
Ranked-choice voting allows voters to express additional preferences, but it requires compatible ballot design, counting procedures, election systems and voter education. The U.S. Election Assistance Commission recognizes that alternative voting methods create distinct administrative and implementation considerations for election officials.[fn:13]
...
** Improving the Existing System or Rebuilding Its Foundation
...
[fn:1] Code of Virginia § 30-392 establishes a 16-member commission composed of eight legislative commissioners and eight citizen commissioners. The legislative members are appointed by the leaders of the two largest parties in each chamber. [[https://law.lis.virginia.gov/vacode/title30/chapter62/section30-392/][Source]]

[fn:2] Code of Virginia §§ 30-393 and 30-394 establish the Redistricting Commission Selection Committee and the process under which legislative leaders submit citizen candidates for selection. [[https://law.lis.virginia.gov/vacodefull/title30/chapter62/][Source]]

[fn:3] Virginia Redistricting Commission, /Summary of Meeting/, June 7, 2021, p. 2. The official summary states that Richard Harrell described the commission as “not nonpartisan but rather bipartisan” and said its members had been selected on a partisan basis. [[https://www.virginiaredistricting.org/2021/Data/public%20hearings/sm060721.pdf][Source]]

[fn:4] Arizona Constitution, Article IV, Part 2, § 1, establishes the five-member Arizona Independent Redistricting Commission and its appointment process. [[https://www.azleg.gov/const/4/1.p2.htm][Source]]

[fn:5] The Arizona Constitution requires the applicant pool to contain nominees from each of the two largest political parties and nominees not registered with either of those parties. [[https://www.azleg.gov/const/4/1.p2.htm][Source]]

[fn:6] U.S. Election Assistance Commission, /Alternative Voting Methods in the United States/, describing ranked ballots and successive-round tabulation methods. [[https://www.eac.gov/election-officials/alternative-voting-methods-united-states][Source]]

[fn:7] U.S. Census Bureau, “2011 Geography Changes,” explaining that ZIP Codes are collections of postal delivery routes rather than geographic areas. [[https://www.census.gov/programs-surveys/acs/technical-documentation/table-and-geography-changes/2011/geography-changes.html][Source]]

[fn:8] U.S. Census Bureau, “ZIP Code Tabulation Areas,” defining ZCTAs as generalized area representations of point-based ZIP Codes constructed from census blocks. [[https://www.census.gov/programs-surveys/geography/guidance/geo-areas/zctas.html][Source]]

[fn:9] U.S. Census Bureau materials explain that ZCTAs are approximate representations of postal service areas and may cross county, place and, in a small number of cases, state boundaries. [[https://www.census.gov/programs-surveys/geography/about/glossary.html][Source]]

[fn:10] The Supreme Court’s one-person, one-vote doctrine requires separately elected districts to provide substantially equal representation. See /Reynolds v. Sims/, 377 U.S. 533 (1964), and the Court’s summary of the doctrine in /Evenwel v. Abbott/. [[https://www.supremecourt.gov/qp/14-00940qp.pdf][Source]]

[fn:11] U.S. Department of Justice, /Guidance Under Section 2 of the Voting Rights Act/, explaining that Section 2 applies nationwide to districting plans and methods of electing public officials and prohibits both intentionally discriminatory practices and practices producing discriminatory results. [[https://www.justice.gov/crt/case-document/file/1429826/dl?inline=][Source]]

[fn:12] In /Rucho v. Common Cause/, the Supreme Court discussed partisan gerrymandering claims involving district lines drawn to subordinate one political party’s supporters and entrench another party in power. [[https://www.supremecourt.gov/opinions/18pdf/18-422_9ol1.pdf][Source]]

[fn:13] U.S. Election Assistance Commission, /Alternative Voting Methods in the United States/. [[https://www.eac.gov/election-officials/alternative-voting-methods-united-states][Source]]
